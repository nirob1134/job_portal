          ...
          child: Stack(
            children: [
              Positioned(
                ...
                child: Container(width: 4, color: const Color(0xFFF5A623)),
              ),
              Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            runSpacing: 6,
                            children: [
                              _miniChip(Icons.alt_route_outlined, transport.route, const Color(0xFF4A90E2)),
                              _miniChip(Icons.paid_outlined, "৳${transport.salary}", const Color(0xFF10B981)),
                            ],
                          ),
                        ],
                      ),
